...
- This skill pairs naturally with `/design-api` (formalizing a discovered API surface into an OpenAPI or GraphQL spec) and `/review-code` (reviewing the code within an identified call chain for correctness or security).

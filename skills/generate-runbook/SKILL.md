...
- This skill pairs naturally with `/platform-readiness` (which checks whether a runbook exists as part of its CI/CD pillar) and `/incident-review` (which references runbook procedures during postmortems).

...
- This skill pairs naturally with `/write-adr` (for individual decisions that emerge from RFC review) and `/spec-to-backlog` (to convert an accepted RFC into implementation stories).
